...
public class StringUtil {
	...
	public static String ISO88591ToUTF8(String org) {
	...
	/**
	 * 对html的特殊符号进行转义，以插入xml
	 * 
	 * @param htmlStr
	 * @return
	 */
	public static String converHtmlIntoXML(String htmlStr) {
	 ...
	 * @return 指定格式的日期字符串
	 */
	public static String getDateStrWithFormat(String pattern){
